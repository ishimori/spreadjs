...
| DD | 件名 | ステータス | 補足 |
|----|------|-----------|------|
| DD-049 | 共同編集の受理通知とPresence公開 | 確認待ち | 実装・Codex 2 回（指摘 5 件反映）・全回帰 green。コミットと alpha 配布（広島 DD-005-3 引き渡し）の判断待ち |
| DD-049-1 | 変更者の可視化 | 検討中 | DD-049 論点 3 で分離。Human Spec Gate（論点 1〜4）待ち・DD-049 完了後に着手 |
