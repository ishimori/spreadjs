...
export type GridEvent =
   ...
   */
  | { readonly type: 'header-click'; readonly columnId: string }
  /**
   ...
   */
  | { readonly type: 'cell-hover'; readonly rowId: string | null; readonly columnId: string | null; readonly rect: GridCellRect | null };
